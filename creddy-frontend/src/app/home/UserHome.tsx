...
export default function UserHome() {
    return (
        <div className="md:mx-24 mx-12">
            <h1 className="text-4xl mt-4 py-2 font-semibold">Welcome back, {collapseAddress(localStorage.getItem("keylessAccount") ? JSON.parse(localStorage.getItem("keylessAccount")!).accountAddress : "")}</h1>
