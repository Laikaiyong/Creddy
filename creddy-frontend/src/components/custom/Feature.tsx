...
const features = [
        ...
        },
        {
            ...
            desc: "NFTs can be converted into education credits, simplifying the process of transferring and recognizing skills and knowledge across institutions."
        },
        {
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            desc: "Personal skills and traits are visualized based on the tags associated with earned NFTs, allowing for a comprehensive overview of a learner’s capabilities.."
        },
    ]
