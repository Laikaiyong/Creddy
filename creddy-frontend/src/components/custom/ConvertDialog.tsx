		...
		<Dialog>
			...
			<DialogContent className='sm:max-w-[425px]'>
					...
					<DialogDescription className='pt-2'>
						...
						<div className='p-2 border border-purple-500 rounded-md mt-4 bg-purple-100'>
							...
							<div className='flex items-center space-x-2 text-purple-700'>
								...
								<p>
									You have up to <strong>0 (+0) credits</strong>
									{"available towards a Bachelor's degree. Credits vary by degree."}
								</p>
							</div>
						</div>
					</DialogDescription>
				...
				<div className='grid gap-4 py-4'>
					<div className='grid grid-cols-4 items-center gap-4'>{/* Content here */}</div>
					<div className='grid grid-cols-4 items-center gap-4'>{/* Content here */}</div>
				</div>
				<DialogFooter>
