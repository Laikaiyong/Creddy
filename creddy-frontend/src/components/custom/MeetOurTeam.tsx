...
const team = [
	...
	},
	{
		...
		name: "Tan Wei Hup",
		image:
			"https://media.licdn.com/dms/image/v2/D5603AQErINuui8DiQA/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1703865131897?e=1729123200&v=beta&t=36W0JynxmaodR88rlGfI4wTq-wngdrLV0J2fIlEMkD0",
		role: "zkKing",
			...
			<Carousel>
				<CarouselContent className='flex lg:items-center lg:justify-center lg:space-x-10'>
					{team.map((member) => (
						<CarouselItem
							key={member.id}
							className='basis-[44%] min-w-[220px] lg:max-w-[280px] lg:basis-1/4'
						>
							<a href={member.link} target='_blank'>
								<img
									src={member.image}
									alt={member.name}
									className='w-full h-auto rounded-full border-[3px] border-purple-600'
								/>
							</a>
